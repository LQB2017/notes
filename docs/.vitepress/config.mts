      ...
      '/自考/计算机信息管理本科毕业设计(实)/': [
        {
          ...
          items: [
            { text: '概述', link: '/自考/计算机信息管理本科毕业设计(实)' }
          ]
        },
      ],
      '/自考/概率论与数理统计(经管类)/': [
